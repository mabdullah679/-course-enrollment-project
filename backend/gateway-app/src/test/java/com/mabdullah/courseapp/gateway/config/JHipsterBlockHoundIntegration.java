...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.mabdullah.courseapp.gateway.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.mabdullah.courseapp.gateway.security.DomainUserDetailsService", "createSpringSecurityUser");
